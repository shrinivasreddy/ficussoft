...
export default function PremiumExperience() {
  ...
  return <div className="premium-site">
    ...
    <section className="px-hero px-hero-visual" id="home" ref={heroRef} onMouseMove={updatePointer}><div className="px-hero-image" aria-hidden="true"/><div className="px-hero-shade" aria-hidden="true"/><div className="px-hero-glow" style={{ left: `${pointer.x}%`, top: `${pointer.y}%` }} aria-hidden="true"/><div className="px-wrap px-hero-content"><div className="px-kicker"><i/> SILICON VALLEY PRODUCT DEVELOPMENT · GLOBAL TEAMS</div><h1>Bringing tomorrow’s<br/><span>solution, today.</span><i>✳</i></h1><p>Great ideas, brought to life with technology. In weeks, not years.</p><div className="px-actions"><a href="#contact" className="px-btn px-btn-light">Start something good <Arrow/></a><a href="#work" className="px-link">See what we make <span>↓</span></a></div><div className="px-hero-foot"><span>California · India · United Kingdom · Italy</span><span>SCROLL TO DISCOVER ↓</span></div></div><div className="px-hero-card"><span>THE FICUSSOFT WAY</span><strong>Trust → partnership</strong><i>Technology built together.</i></div></section>
